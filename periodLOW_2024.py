...
def readcsvgetpf(indir, infilename):
    ...
    for i in range(0, len(pf)):  # 民國轉西元
        ...
        pf.at[i, '日期'] = pf.at[i, '日期'].replace('113', '2024')
        pf.at[i, '日期'] = pf.at[i, '日期'].replace('114', '2025')
        pf.at[i, '日期'] = pf.at[i, '日期'].replace('115', '2026')
        pf.at[i, '日期'] = pf.at[i, '日期'].replace('116', '2027')
        pf.at[i, '日期'] = pf.at[i, '日期'].replace('117', '2028')
        pf.at[i, '日期'] = pf.at[i, '日期'].replace('118', '2029')
        pf.at[i, '日期'] = pf.at[i, '日期'].replace('119', '2030')
